    ...
    <>
      <Routes>
        ...
        <Route element={<ProtectedRoute allowedRoles={["ROLE_BANKMANAGER"]} />}>
          ...
          <Route
            path="/ViewAllBankAccounts"
            element={<ViewAllBankAccounts />}
          />
          <Route
            path="/ViewAllBankCustomers"
            element={<ViewAllBankCustomers />}
          />
          <Route
            path="/customerProfileForManager/:customerId"
            element={<CustomerProfileForManager />}
          />
          "
          <Route
            path="/bank/transactions"
            element={<ViewAllCustomerTransactions />}
          />
        </Route>
        ...
        <Route
          element={
            <ProtectedRoute
              allowedRoles={["ROLE_CUSTOMER", "ROLE_BANK_MANAGER"]}
            />
          }
        >
          <Route
            path="/customer/bank/account/detail/:accountId"
            element={<ViewBankAccountWrapper />}
          />
          <Route
            path="/ViewSpecificAccountDetails/:customerId/:accountId"
            element={<ViewSpecificAccountDetails />}
          />
          <Route
            path="/ManageBankAccount/:accountId"
            element={<ManageAccountWrapper />}
          />
          <Route
